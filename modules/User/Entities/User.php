...
use Tymon\JWTAuth\Facades\JWTAuth; // For JWT


class User extends EloquentUser implements AuthenticatableContract, JWTSubject
{
    ...
    // Passport Token Generation (For Laravel Passport)
    ...
    // JWT Required Methods (For JWTAuth)
    public function getJWTIdentifier()
    {
        return $this->getKey(); // returns the primary key (id) of the user
    }
