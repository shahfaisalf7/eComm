...
abstract class BaseAuthController extends Controller
{
    ...
    {
        if (request()->routeIs('api.login') && auth()->check()) {
            return;
        }
        $this->auth = $auth;
            ...
            if (isAPI()) {
                ...
                if (auth()->attempt($credentials)) {
                    ...
                    if ($authMethod === 'jwt') {
                        ...
                        return response()->json(['message' => 'Invalid auth method'], 400);
                    }
    ...
    public function postLogout()
    {
        if (auth()->check()) {
            ...
            return response()->json(['status' => 'error', 'message' => 'Someting want wrong!'], 500);
        }
    }
