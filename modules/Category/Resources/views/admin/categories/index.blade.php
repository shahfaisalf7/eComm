            ...
            <div class="col-lg-10 col-md-9">
                <div class="tab-wrapper category-details-tab">
                    <ul class="nav nav-tabs">
                        ...
                        @endHasAccess
                        <li class="seo-tab"><a data-toggle="tab" href="#seo">{{ trans('category::categories.tabs.seo') }}</a></li>
                    </ul>
                        ...
                        <div class="tab-content">
                            <div id="general-information" class="tab-pane fade in active">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        {{ Form::textarea('description', trans('category::attributes.description'), $errors, null, ['id' => 'description', 'rows' => 6, 'class' => 'wysiwyg']) }}
                            ...
                            @if (auth()->user()->hasAccess('admin.media.index'))
                                <div id="image" class="tab-pane fade">
                                    <div class="logo">
                                        @include('media::admin.image_picker.single', ['title' => trans('category::categories.form.logo'), 'inputName' => 'files[logo]', 'file' => (object) ['exists' => false]])
                                    </div>
                                    <div class="banner">
                                        @include('media::admin.image_picker.single', ['title' => trans('category::categories.form.banner'), 'inputName' => 'files[banner]', 'file' => (object) ['exists' => false]])
                                    </div>
                                </div>
                            @endif
                            ...
                            <div id="seo" class="tab-pane fade">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        {{ Form::text('meta[meta_title]', trans('meta::attributes.meta_title'), $errors) }}
                                        {{ Form::textarea('meta[meta_description]', trans('meta::attributes.meta_description'), $errors, null, ['rows' => 6]) }}
                                    </div>
                                </div>
                            </div>
                        </div>
