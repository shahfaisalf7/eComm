<aside class="localization" :class="{ active: $store.layout.isOpenlocalizationMenu }">
    <div class="localization-header">
        <p>{{ trans('storefront::layouts.language_and_currency') }}</p>
    ...
    <div class="localization-form">
        <div class="form-group">
            <label for="language">{{ trans('storefront::layouts.language') }}</label>
        ...
        <div class="form-group">
            <label for="currency">{{ trans('storefront::layouts.currency') }}</label>
