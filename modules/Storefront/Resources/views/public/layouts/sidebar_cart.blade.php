...
>
    <div class="sidebar-cart-top">
        <p class="title">
            ...
            <div class="count" style="background-color: #e33b80 !important;" x-text="$store.state.cartQuantity">
    ...
    >
        ...
        <template x-if="cartIsEmpty">
            <div class="empty-message">
                ...
                <p>{{ trans('storefront::cart.your_cart_is_empty') }}</p>
            </div>
        </template>
    </div>
    ...
    <template x-if="!cartIsEmpty">
        <div class="sidebar-cart-bottom">
            ...
            <div class="sidebar-cart-actions">
                ...
                @else
                    <a class="btn btn-primary btn-checkout" data-bs-toggle="modal" data-bs-target="#static_login_modal">
                        {{ trans('storefront::layouts.checkout') }}
                    </a>
                @endif
            </div>
