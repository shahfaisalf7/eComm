    ...
    <div class="table-responsive">
        <table class="table table-bordered compare-table">
            ...
            <tr>
                ...
                <template x-for="(product, index) in products" :key="index">
                    <td x-html="product.short_description || '-'"></td>
                </template>
            </tr>
            ...
            {{--                    <template x-for="(product, index) in products" :key="index">--}}
            {{--                        <td>--}}
            {{--                            @include('storefront::public.partials.product_rating', ['product' => $compare->products()->get($index)])--}}
            {{--                        </td>--}}
            {{--                    </template>--}}
            {{--                </tr>--}}
            <!-- Rating row with Blade loop -->
            <tr>
                <td>{{ trans('storefront::compare.rating') }}</td>
                @foreach($compare->products() as $product)
                    <td>
                        @include('storefront::public.partials.product_rating', ['product' => $product])
                    </td>
                @endforeach
            </tr>
            <tr>
