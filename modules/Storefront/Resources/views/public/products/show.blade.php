...
@push('meta')
    ...
    <meta property="og:image"
        content="{{ $product->variant && $product->variant->base_image->id ? $product->variant->base_image?->path : $product->base_image?->path ?? asset('build/assets/image-placeholder.png') }}">
    ...
    <meta property="product:price:amount"
        content="{{ $product->variant?->selling_price->convertToCurrentCurrency()->amount() ?? $product->selling_price->convertToCurrentCurrency()->amount() }}">
...
@section('content')
    <section x-data="ProductShow({
        product: {{ $product }},

        @if ($product->variant) variant: {{ $product->variant }}, @endif
        ...
        <div class="container">
            <div class="product-details-top">
                <div class="d-flex flex-column flex-lg-row flex-lg-nowrap ">
                    ...
                    @include('storefront::public.products.show.details', [
...
@push('globals')
    ...
    @vite(['modules/Storefront/Resources/assets/public/sass/pages/products/show/main.scss', 'modules/Storefront/Resources/assets/public/js/pages/products/show/main.js', 'modules/Storefront/Resources/assets/public/js/vendors/flatpickr.js'])
@endpush
@push('storefrontCss')
    @vite(['modules/Storefront/Resources/assets/public/sass/app.scss', 'modules/Storefront/Resources/assets/public/js/app.js', 'modules/Storefront/Resources/assets/public/js/main.js'])
@endpush
