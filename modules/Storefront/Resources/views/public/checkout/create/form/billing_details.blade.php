<div class="billing-details">
    <p class="section-title">{{ trans('storefront::checkout.billing_details') }}</p>
    ...
    <template x-if="hasAddress">
        <div x-cloak class="address-card-wrap">
            ...
            <template x-if="!form.newBillingAddress && errors.has('billing.address_1')">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="form-group">
                        <label for="billing-full-name">
                            {{ trans('checkout::attributes.billing.full_name') }}<span>*</span>
                        </label>
                        ...
                        <input
                            ...
                            class="form-control"
                            x-model="form.billing.full_name"
                        >

                        <template x-if="errors.has('billing.full_name')">
                            <span class="error-message" x-text="errors.get('billing.full_name')"></span>
                        </template>
                    </div>
                </div>
                ...
                <div class="col-md-9">
                    <div class="form-group">
                        <label for="billing-phone">
                            {{ trans('checkout::attributes.billing.phone_number') }}<span>*</span>
                        </label>
                ...
                <div class="col-md-9">
                    <div class="form-group">
                        ...
                        <template x-if="!hasBillingCities">
                            <input
                                type="text"
                                name="billing[city]"
                                id="billing-city"
                        ...
                        <template x-if="hasBillingCities">
                            <select
                                ...
                                id="billing-city"
                                class="form-control arrow-black"
                                @change="changeBillingCities($event.target.value)"
                            >
                                <option value="">{{ trans('storefront::checkout.please_select') }}</option>

                                <template x-for="(name, code) in cities.billing" :key="code">
                                    <option :value="code" x-html="name"></option>
                                </template>
                            </select>
                        </template>
                ...
                <div class="col-md-9">
                    <div class="form-group">
                        <label for="billing-zone">
                            {{ trans('checkout::attributes.billing.zone') }}<span>*</span>
                        </label>

                        <template x-if="!hasBillingZones">
                            <input
                                type="text"
                                name="billing[zone]"
                                id="billing-zone"
                                class="form-control"
                                x-model="form.billing.zone"
                            >
                        </template>
                        ...
                        <template x-if="hasBillingZones">
                            <select
                                ...
                                id="billing-zone"
                                class="form-control arrow-black"
                                @change="changeBillingZones($event.target.value)"
                            >
                                <option value="">{{ trans('storefront::checkout.please_select') }}</option>

                                <template x-for="(name, code) in zones.billing" :key="code">
                                    <option :value="code" x-html="name"></option>
                                </template>
                            </select>
                        </template>

                        <template x-if="errors.has('billing.zone')">
                            <span class="error-message" x-text="errors.get('billing.zone')"></span>
                        </template>
                    </div>
                </div>
            </div>
