    ...
    <div class="row">
        <div class="col-md-18">
            <div class="form-group ship-to-different-address-label">
                <div class="form-check">
                    <input
                        ...
                        @click="loadMetaDataIfNoAddressFound()"
                    >
            ...
            <div x-cloak x-show="form.ship_to_a_different_address" class="ship-to-different-address-form">
                <p class="section-title">{{ trans('storefront::checkout.shipping_details') }}</p>
                ...
                <div class="add-new-address-wrap">
                    ...
                    <div class="add-new-address-form" x-show="!hasAddress || form.newShippingAddress">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <label for="shipping-full-name">
                                        {{ trans('checkout::attributes.shipping.full_name') }}<span>*</span>
                                    </label>
                                    ...
                                    <input
                                        ...
                                        class="form-control"
                                        x-model="form.shipping.full_name"
                                    >

                                    <template x-if="errors.has('shipping.full_name')">
                                        <span class="error-message" x-text="errors.get('shipping.full_name')"></span>
                                    </template>
                                </div>
                            </div>
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <label for="shipping-phone">
                                        {{ trans('checkout::attributes.shipping.phone_number') }}<span>*</span>
                                    </label>
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    ...
                                    <template x-if="!hasShippingCities">
                                        <input
                                            type="text"
                                            name="shipping[city]"
                                            id="shipping-city"
                                    ...
                                    <template x-if="hasShippingCities">
                                        <select
                                            ...
                                            id="shipping-city"
                                            class="form-control arrow-black"
                                            @change="changeShippingCities($event.target.value)"
                                        >
                                            <option value="">{{ trans('storefront::checkout.please_select') }}</option>

                                            <template x-for="(name, code) in cities.shipping" :key="code">
                                                <option :value="code" x-html="name"></option>
                                            </template>
                                        </select>
                                    </template>
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <label for="shipping-zone">
                                        {{ trans('checkout::attributes.shipping.zone') }}<span>*</span>
                                    </label>

                                    <template x-if="!hasShippingZones">
                                        <input
                                            type="text"
                                            name="shipping[zone]"
                                            id="shipping-zone"
                                            class="form-control"
                                            x-model="form.shipping.zone"
                                        >
                                    </template>
                                    ...
                                    <template x-if="hasShippingZones">
                                        <select
                                            ...
                                            id="shipping-zone"
                                            class="form-control arrow-black"
                                            @change="changeShippingZones($event.target.value)"
                                        >
                                            <option value="">{{ trans('storefront::checkout.please_select') }}</option>

                                            <template x-for="(name, code) in zones.shipping" :key="code">
                                                <option :value="code" x-html="name"></option>
                                            </template>
                                        </select>
                                    </template>

                                    <template x-if="errors.has('shipping.zone')">
                                        <span class="error-message" x-text="errors.get('shipping.zone')"></span>
                                    </template>
                                </div>
                            </div>
                        </div>
