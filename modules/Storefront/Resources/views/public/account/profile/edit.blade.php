...
@section('panel')
    <div class="panel">
        <div class="panel-header">
            <p>{{ trans('storefront::account.pages.my_profile') }}</p>
        </div>
        ...
        <div class="panel-body mb-5">
            <div class="my-profile">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="form-group">
                                <label for="name">
                                    {{ trans('storefront::account.profile.name') }}<span>*</span>
                                </label>

                                <input type="text" name="name" value="{{ old('name', $account->full_name) }}"
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                <label for="dob">
                                    {{ trans('storefront::account.profile.dob') }}<span></span>
                                </label>

                                <input type="date" name="dob" value="{{ old('dob', $account->dob ?? null) }}" id="dob"
                ...
                <div class="row mt-3">
                    <div class="col-md-9">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <span type="submit" class="input-group-text" data-bs-toggle="modal"
                                    data-bs-target="#email_change_modal" style="background-color: #e33b80 !important;">
                                    <i class="la la-edit text-white" id="edit-email"></i>
                                </span>
                            </div>
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" value="{{ $account->phone }}" class="form-control" disabled>
                                <span type="submit" class="input-group-text pr-color" data-bs-toggle="modal"
                                    data-bs-target="#phone_change_modal" class="la la-edit"
                                    style="background-color: #e33b80 !important;">
                                    <i class="la la-edit text-white" id="edit-phone"></i>
                                </span>
                            </div>
                    ...
                    <div class="col-md-9">
                        <button class="btn btn-lg btn-primary password-changes" data-bs-toggle="modal"
                            data-bs-target="#password_change_modal" data-loading>
                            <i class="la la-edit text-white" id="edit-phone"></i> {{ __('Set/Change Password') }}
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div x-data="Addresses({
            ...
            <div class="panel-header">
                <p>{{ trans('storefront::account.pages.my_addresses') }}</p>
            </div>
                            ...
                            <div class="row">
                                <template x-for="address in addresses" :key="address.id">
                                    <div class="col-xl-6 col-lg-9 d-flex">
                                        <address class="address-card d-flex flex-column justify-content-between"
                                            :class="{
                                                active: defaultAddress.address_id === address.id
                                            }"
                                            @click="changeDefaultAddress(address)">
                                            <svg class="address-card-selected-icon" xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <div class="address-card-data">
                                                ...
                                                <span x-html="`${address.state}, ${address.city}, ${address.zone}`"></span>
                                                <span x-text="address.country_name"></span>
                                            </div>

                                            <div class="address-card-actions">
                                                <button type="button" class="btn btn-edit-address"
                                                ...
                                                <button type="button" class="btn btn-delete-address"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        ...
                                                        <path
                                                            ...
                                                            stroke="#292D32" stroke-width="1.5" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M10.33 16.5H13.66" stroke="#292D32" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <div class="add-new-address-form">
                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <label for="full-name">
                                                {{ trans('storefront::account.addresses.full_name') }}<span>*</span>
                                            </label>

                                            <input name="full_name" type="text" id="full-name" class="form-control"
                                                x-model="form.full_name">

                                            <template x-if="errors.has('full_name')">
                                                <span class="error-message" x-text="errors.get('full_name')"></span>
                                            </template>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <label for="phone-number">
                                                {{ trans('storefront::account.addresses.phone_number') }}<span>*</span>
                                            </label>

                                            <input name="phone_number" type="text" id="phone-number"
                                                class="form-control" value="{{ auth()->user()->phone }}" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-18">
                                        <div class="form-group">
                                            ...
                                            <input name="address_1" type="text" id="address-1"
                                                placeholder="{{ trans('storefront::account.addresses.address_line_1') }}"
                                                class="form-control" x-model="form.address_1">
                                        ...
                                        <div class="form-group">
                                            <input name="address_2" type="text" id="address-2"
                                                placeholder="{{ trans('storefront::account.addresses.address_line_2') }}"
                                                class="form-control" x-model="form.address_2">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <template x-if="!hasNoStates">
                                                <select name="state" id="state" class="form-control arrow-black"
                                                    x-model="form.state" @change="changeState($event.target.value)">
                                                    <option value="">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            ...
                                            <template x-if="hasNoCities">
                                                <input type="text" id="city" class="form-control"
                                                    x-model="form.city" disabled>
                                            </template>

                                            <template x-if="!hasNoCities">
                                                <select name="city" id="city" class="form-control arrow-black"
                                                    x-model="form.city" @change="changeCity($event.target.value)">
                                                    <option value="">
                                                        {{ trans('storefront::account.addresses.please_select') }}
                                                    </option>

                                                    <template x-for="(name, code) in cities">
                                                        <option :value="code" x-html="name"></option>
                                                    </template>
                                                </select>
                                            </template>
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <label for="zone">
                                                {{ trans('storefront::account.addresses.zone') }}<span>*</span>
                                            </label>

                                            <template x-if="hasNoZones">
                                                <input type="text" id="zone" class="form-control"
                                                    x-model="form.zone" disabled>
                                            </template>

                                            <template x-if="!hasNoZones">
                                                <select name="zone" id="zone" class="form-control arrow-black"
                                                    x-model="form.zone">
                                                    <option value="">
                                                        {{ trans('storefront::account.addresses.please_select') }}
                                                    </option>

                                                    <template x-for="(name, code) in zones">
                                                        <option :value="code" x-html="name"></option>
                                                    </template>
                                                </select>
                                            </template>

                                            <template x-if="errors.has('zone')">
                                                <span class="error-message" x-text="errors.get('zone')"></span>
                                            </template>
                                        </div>
                                    </div>
    ...
    @include('storefront::public.account.profile.email_change_modal')
    @include('storefront::public.account.profile.phone_change_modal')
    @include('storefront::public.account.profile.password_change_modal')
@endsection

@push('globals')
    @vite(['modules/Storefront/Resources/assets/public/sass/pages/account/profile/main.scss'])
