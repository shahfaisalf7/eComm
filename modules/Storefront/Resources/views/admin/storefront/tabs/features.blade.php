<div class="row">
    <div class="col-md-8">
        ...
        <div class="box-content">
            <p class="section-title">{{ trans('storefront::storefront.form.feature_1') }}</p>
        ...
        <div class="box-content">
            <p class="section-title">{{ trans('storefront::storefront.form.feature_2') }}</p>
        ...
        <div class="box-content">
            <p class="section-title">{{ trans('storefront::storefront.form.feature_3') }}</p>
        ...
        <div class="box-content">
            <p class="section-title">{{ trans('storefront::storefront.form.feature_4') }}</p>
        ...
        <div class="box-content">
            <p class="section-title">{{ trans('storefront::storefront.form.feature_5') }}</p>
