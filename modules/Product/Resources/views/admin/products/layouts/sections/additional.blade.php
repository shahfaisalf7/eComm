<template v-else-if="section === 'additional'">
    <div class="box-header">
        <p>{{ trans('product::products.group.additional') }}</p>
    ...
    <div class="box-body">
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <textarea name="short_description" rows="6" cols="10" id="short-description" class="form-control wysiwyg" v-model="form.short_description"></textarea>
