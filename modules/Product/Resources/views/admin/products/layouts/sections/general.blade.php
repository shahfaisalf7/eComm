<div class="box">
    <div class="box-header">
        <p>{{ trans('product::products.group.general') }}</p>
    </div>
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                ...
                <span class="help-block text-red" v-if="errors.has('weight')" v-text="errors.get('weight')"></span>
            </div>
        </div>
