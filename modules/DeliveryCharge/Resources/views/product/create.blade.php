...
@component('admin::components.page.header')
    @slot('title', 'Create Product Charge', ['resource' => 'Product Charge'])

    <li><a href="{{ route('admin.product.charge') }}">{{ __('Product Charge') }}</a></li>
    <li class="active">{{ __('Create Product Charge') }}</li>
@endcomponent

@section('content')
    <form method="POST" action="{{ route('admin.product.charge.store') }}" class="form-horizontal"
        id="product-charege-create-form" novalidate>
        {{ csrf_field() }}
