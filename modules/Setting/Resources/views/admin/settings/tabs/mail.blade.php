<div class="row">
    <div class="col-md-8">
        ...
        <div class="box-content clearfix">
            <p class="section-title">{{ trans('setting::settings.form.customer_notification_settings') }}</p>
        ...
        <div class="box-content clearfix">
            <p class="section-title">{{ trans('setting::settings.form.order_notification_settings') }}</p>
