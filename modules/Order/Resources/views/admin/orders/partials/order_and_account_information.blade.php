<div class="order-information-wrapper">
    ...
    <p class="section-title">{{ trans('order::orders.order_and_account_information') }}</p>

    <div class="row">
        <div class="col-md-6">
            <div class="order clearfix">
                <p>{{ trans('order::orders.order_information') }}</p>
        ...
        <div class="col-md-6">
            <div class="account-information">
                <p>{{ trans('order::orders.account_information') }}</p>
